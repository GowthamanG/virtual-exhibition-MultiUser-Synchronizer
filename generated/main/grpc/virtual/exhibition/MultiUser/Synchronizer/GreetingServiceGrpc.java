...
public final class GreetingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "virtual.exhibition.MultiUser.Synchronizer.GreetingService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<virtual.exhibition.MultiUser.Synchronizer.HelloRequest,
      virtual.exhibition.MultiUser.Synchronizer.HelloResponse> getGreetingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "greeting",
      requestType = virtual.exhibition.MultiUser.Synchronizer.HelloRequest.class,
      responseType = virtual.exhibition.MultiUser.Synchronizer.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<virtual.exhibition.MultiUser.Synchronizer.HelloRequest,
      virtual.exhibition.MultiUser.Synchronizer.HelloResponse> getGreetingMethod() {
    io.grpc.MethodDescriptor<virtual.exhibition.MultiUser.Synchronizer.HelloRequest, virtual.exhibition.MultiUser.Synchronizer.HelloResponse> getGreetingMethod;
      ...
      synchronized (GreetingServiceGrpc.class) {
        if ((getGreetingMethod = GreetingServiceGrpc.getGreetingMethod) == null) {
          GreetingServiceGrpc.getGreetingMethod = getGreetingMethod = 
              io.grpc.MethodDescriptor.<virtual.exhibition.MultiUser.Synchronizer.HelloRequest, virtual.exhibition.MultiUser.Synchronizer.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "virtual.exhibition.MultiUser.Synchronizer.GreetingService", "greeting"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  virtual.exhibition.MultiUser.Synchronizer.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  virtual.exhibition.MultiUser.Synchronizer.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(virtual.exhibition.MultiUser.Synchronizer.HelloRequest request,
        io.grpc.stub.StreamObserver<virtual.exhibition.MultiUser.Synchronizer.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                virtual.exhibition.MultiUser.Synchronizer.HelloRequest,
                virtual.exhibition.MultiUser.Synchronizer.HelloResponse>(
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public virtual.exhibition.MultiUser.Synchronizer.HelloResponse greeting(virtual.exhibition.MultiUser.Synchronizer.HelloRequest request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<virtual.exhibition.MultiUser.Synchronizer.HelloResponse> greeting(
        virtual.exhibition.MultiUser.Synchronizer.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((virtual.exhibition.MultiUser.Synchronizer.HelloRequest) request,
              (io.grpc.stub.StreamObserver<virtual.exhibition.MultiUser.Synchronizer.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return virtual.exhibition.MultiUser.Synchronizer.ExampleServices.getDescriptor();
    }
